...
__device__ void wigNaiveAnalysis_symX( int ,
				   int ,
				   int ,
				   double * ,
				   double * ,
...
__device__ void wigNaiveAnalysis_symY( int ,
				   int ,
				   int ,
				   double * ,
				   double * ,
...
__device__ void wigNaiveSynthesis_symX( int ,
				    int ,
				    int ,
				    double * ,
				    double * ,
...
__device__ void wigNaiveSynthesis_symY( int ,
				    int ,
				    int ,
				    double * ,
				    double * ,
