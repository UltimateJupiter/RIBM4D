...
__device__ double L2_aN_so3( int ,
		     int ,
		     int ) ;

__device__ double L2_bN_so3( int ,
		     int ,
		     int ) ;

__device__ double L2_cN_so3( int ,
		     int ,
		     int ) ;

__device__ void EvalPtsW( int ,
		      double * ) ;

__device__ void CosEvalPts( int ,
			double * ) ;

__device__ void SinEvalPts( int ,
			double * ) ;

__device__ void CosEvalPts2( int ,
			 double * ) ;

__device__ void SinEvalPts2( int ,
			 double * ) ;

__device__ void wigSpec_L2( int ,
			int ,
			double * ,
			double * ,
			int ,
...
__device__ void genWig_L2_U( int ,
			 int ,
			 int ,
			 int ,
			 double * ,
...
__device__ void genWigTrans_L2( int ,
			    int ,
			    int ,
			    double * ,
			    double * ,
...
__device__ void genWigAll( int ,
		       double * ,
		       double * ) ;

__device__ void genWigAllTrans( int ,
			    double * ,
			    double * ) ;
