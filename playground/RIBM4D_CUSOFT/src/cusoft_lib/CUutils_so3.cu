...
__device__ void vec_add_so3( double *data1,
		  double *data2,
		  double *result,
		  int n )
{
...
*/
__device__ void vec_mul_so3( double scalar,
		  double *data1,
		  double *result,
		  int n)
{
...
/*
   ...
   'scalar' IN PLACE!!! 
*/
__device__ void vec_mul_inplace_so3( double scalar,
			  double *data,
			  int n)
{
   int k;
...
*/
__device__ void vec_add_scalar_so3( double scalar,
			 double *data1,
			 double *result,
			 int n)
{
...
/* point-by-point multiplication of length n vectors data1, data2,
 ...
 __device__ void vec_pt_mul_so3( double *data1,
		     double *data2,
		     double *result,
		     int n)
{
...
__device__ double vec_inner_so3( double *data1,
		      double *data2,
		      int n )
{
  int k ;
...
__device__ void transpose_so3( double *arrayIn,
		    double *arrayOut,
		    int m,
		    int n )
{
...
__device__ int totalCoeffs_so3( int bw )
{
...
__device__ int numCoeffs_so3( int bw,
		   int m1 )
{
...
__device__ int howMany_so3( int m1,
		 int m2,
		 int bw )
{
  int m ;
...
__device__ int sampLoc_so3( int m1, int m2, int bw )
{
  if ( m1 >= 0 )
    {
      if ( m2 >= 0 )
...
__device__ int coefLoc_so3( int m1, int m2, int bw )
{
...
__device__ int so3CoefLoc( int m,
		int mp,
		int l,
		int bw )
{
