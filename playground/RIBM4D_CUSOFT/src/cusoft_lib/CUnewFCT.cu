...
__device__ static void reverse_it(double *input,
		       double *output,
		       int n)
{
  int i, len;
...
__device__ static void OURpermute(double *data,
		       double *result,
		       int n)
{
  int i;
...
__device__ static void PartitionAdd(double *data,
			 double *result,
			 int n,
			 int k)
{
...
__device__ void kFCT(double *data,
	  double *result,
	  double *workspace,
	  int n,
	  int k,
...
#define IGNORE 1
#ifndef IGNORE
__device__ static void ChebyDivRemOrig(double *dividend,
			    double m0,
			    double *remres,
			    int n)
{
...
__device__ static void ChebyDivRem(double *dividend,
			double m0,
			double *remres,
			int n)
{
...
__device__ void ExpIFCT( double *data,
	      double *result,
	      double *workspace,
	      int n,
	      int k,
