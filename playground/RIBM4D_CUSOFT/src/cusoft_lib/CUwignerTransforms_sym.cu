...
__device__ void wigNaiveAnalysis_symX( int m1,
			    int m2,
			    int bw,
			    double *signal,
			    double *wigners,
...
__device__ void wigNaiveAnalysis_symY( int m1,
			    int m2,
			    int bw,
			    double *signal,
			    double *wigners,
...
__device__ void wigNaiveSynthesis_symX( int m1,
			     int m2,
			     int bw,
			     double *coeffs,
			     double *wignersTrans,
...
__device__ void wigNaiveSynthesis_symY( int m1,
			     int m2,
			     int bw,
			     double *coeffs,
			     double *wignersTrans,
