...
__device__ void Naive_AnalysisX(double *data,
		     int bw,
		     int m,
		     double *result,
		     double *plmtable,
...
__device__ void Naive_SynthesizeX(double *coeffs,
		       int bw,
		       int m,
		       double *result,
		       double *plmtable)
...
__device__ void InvSemiNaiveReduced(double *assoc_legendre_series, 
			 int bw, 
			 int m, 
			 double *result, 
...
__device__ void SemiNaiveReduced(double *data, 
		      int bw, 
		      int m, 
		      double *result, 
