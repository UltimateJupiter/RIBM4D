	   ...
	   char **argv )
{
  ...
  seminaive_naive_tablespace =
    (double *) malloc(sizeof(double) *
		      (k_Reduced_Naive_TableSize(bwIn,bwIn) +
		       k_Reduced_SpharmonicTableSize(bwIn,bwIn)));
  printf("**%d, %d\n", Reduced_Naive_TableSize(bwIn,bwIn), Reduced_SpharmonicTableSize(bwIn,bwIn));
  printf("**%d, %d\n", k_Reduced_Naive_TableSize(bwIn,bwIn), k_Reduced_SpharmonicTableSize(bwIn,bwIn));
