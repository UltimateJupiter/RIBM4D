...
/* source code for generating cosine transforms 
   ...
   */
   ...
   __device__ int TableSize(int m,
           int bw)
   {
       return (((bw/2) * ((bw/2) + 1)) -
         ((m/2)*((m/2)+1)) - ((bw/2) * (m % 2)));
   ...
   */
   ...
   __device__ int Spharmonic_TableSize(int bw)
   {
     int m, sum;
   ...
   */
   ...
   __device__ int Reduced_SpharmonicTableSize(int bw,
           int m)
   {
   ...
   */
   ...
   __device__ int NewTableOffset(int m,
          int l)
   {
       int offset;
       int tm, tl;
   ...
   */
   ...
   __device__ void CosPmlTableGen(int bw,
           int m,
           double *tablespace,
           double *workspace)
   {
...
__device__   int Transpose_RowSize(int row,
             int m,
             int bw)
   {
   ...
   */
   ...
   __device__ void Transpose_CosPmlTableGen(int bw,
               int m,
   ...
   */
   ...
   __device__ double **Spharmonic_Pml_Table(int bw,
               double *resultspace,
               double *workspace)
   {
   ...
   */
   ...
   __device__ double **Transpose_Spharmonic_Pml_Table(double **spharmonic_pml_table, 
             int bw,
             double *resultspace,
             double *workspace)
   {
   ...
   */
   ...
   __device__ static void PmlTableGen(int bw,
         int m,
         double *storeplm,
         double *workspace)
   {
   ...
   */
   ...
   __device__ int Reduced_Naive_TableSize(int bw,
             int m)
   {
   ...
   ***********************************************************/
   ...
   __device__ double **SemiNaive_Naive_Pml_Table(int bw,
              int m,
              double *resultspace,
              double *workspace)
   {
   ...
   */
   ...
   __device__ double **Transpose_SemiNaive_Naive_Pml_Table(double **seminaive_naive_pml_table, 
                  int bw,
                  int m,
                  double *resultspace,
                  double *workspace)
