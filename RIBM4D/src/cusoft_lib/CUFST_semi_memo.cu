...
__device__ void PREALLOC_FST_semi_memo(double *rdata, double *idata,
...
__device__ void FST_semi_memo(double *rdata, double *idata,
		   double *rcoeffs, double *icoeffs, 
		   int size, double **seminaive_naive_table,
		   double *workspace,
		   int isReal,
...
__device__ void InvFST_semi_memo(double *rcoeffs, double *icoeffs, 
