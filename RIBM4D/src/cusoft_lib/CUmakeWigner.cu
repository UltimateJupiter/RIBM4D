...
__device__ double L2_aN_so3( int j,
		  int m1,
		  int m2 )
{
  double dj, dm1, dm2;
...
__device__ double L2_bN_so3( int j,
		  int m1,
		  int m2 )
{
  double dj, dm1, dm2;
...
__device__ double L2_cN_so3( int j,
		  int m1,
		  int m2 )
{
  double dj, dm1, dm2;
...
__device__ void L2_3term_so3( int j, int m1, int m2,
...
__device__ void EvalPtsW( int n,
	       double *eval_pts )
{
  int i;
  double twoN;
...
__device__ void CosEvalPts( int n,
		 double *eval_pts )
{
  int i;
  double twoN;
...
__device__ void SinEvalPts( int n,
		 double *eval_pts )
{
  int i;
  double twoN;
...
__device__ void CosEvalPts2( int n,
		  double *eval_pts )
{
  int i;
  double twoN;
...
__device__ void SinEvalPts2( int n,
		  double *eval_pts )
{
  int i;
  double twoN;
...
__device__ void wigSpec_L2( int m1,
		 int m2,
		 double *sinEval,
		 double *cosEval,
		 int n,
...
__device__ void genWig_L2( int m1,
		int m2,
		int bw,
		double *sinEval,
		double *cosEval,
...
__device__ void genWig_L2_U( int m1,
		  int m2,
		  int bw,
		  int n,
		  double *sinEval,
...
__device__ void genWigTrans_L2( int m1,
		     int m2,
		     int bw,
		     double *sinEval,
		     double *cosEval,
...
__device__ void genWigAll( int bw,
		double *wigners,
		double *workspace )
{
  int m1, m2, n ;
...
__device__ void genWigAllTrans( int bw,
		     double *wigners,
		     double *workspace )
{
  int m1, m2, n ;
